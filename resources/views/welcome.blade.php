    ...
    <div class="absolute inset-0 z-0">
        ...
        <div id="carousel" class="relative h-screen w-full overflow-hidden">
            ...
            <div class="carousel-item absolute inset-0 opacity-100 transition-opacity duration-700">
                <img src="https://source.unsplash.com/random/1920x1080/?library" alt="Library"
            ...
            <div class="carousel-item absolute inset-0 opacity-0 transition-opacity duration-700">
                <img src="https://source.unsplash.com/random/1920x1080/?books" alt="Books"
                    class="w-full h-full object-cover">
                <div class="absolute inset-0 bg-black bg-opacity-50"></div>
                <div class="absolute inset-0 flex items-center justify-center">
                    <div class="text-center text-white mt-32">
            ...
            <div class="carousel-item absolute inset-0 opacity-0 transition-opacity duration-700">
                <img src="https://source.unsplash.com/random/1920x1080/?archive" alt="Archive"
                    class="w-full h-full object-cover">
                <div class="absolute inset-0 bg-black bg-opacity-50"></div>
                <div class="absolute inset-0 flex items-center justify-center">
                    <div class="text-center text-white mt-32">
            ...
            <!-- Carousel controls -->
            <button id="prevSlide"
                class="absolute left-4 top-1/2 -translate-y-1/2 bg-black bg-opacity-30 hover:bg-opacity-50 text-white p-3 rounded-full z-30">
            ...
            <button id="nextSlide"
                class="absolute right-4 top-1/2 -translate-y-1/2 bg-black bg-opacity-30 hover:bg-opacity-50 text-white p-3 rounded-full z-30">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
                    stroke="currentColor">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="flex justify-center">
                        <ul class="flex flex-wrap items-center">
                            <li class="relative">
                                <a href="#"
                                    class="inline-flex items-center px-6 py-4 font-semibold text-sm uppercase bg-primary-blue text-white rounded-b-xl hover:bg-blue-700 transition-colors">
                            ...
                            <li class="relative group">
                                <a href="#"
                                    class="inline-flex items-center px-6 py-4 font-semibold text-sm uppercase text-gray-700 hover:text-primary-blue transition-colors">
                                    <i class="fas fa-users mr-2"></i>
                                    PROFIL
                                    <i
                                        class="fas fa-chevron-down text-xs ml-2 group-hover:rotate-180 transition-transform duration-300"></i>
                                </a>
                                <div
                                    class="absolute hidden group-hover:block bg-white shadow-xl rounded-xl w-56 py-2 z-50 transform -translate-x-1/4 mt-1">
                                    <a href="#"
                                        class="block px-6 py-2 text-sm text-gray-600 hover:text-primary-blue hover:bg-gray-50">Visi
                                        & Misi</a>
                                    <a href="#"
                                        class="block px-6 py-2 text-sm text-gray-600 hover:text-primary-blue hover:bg-gray-50">Struktur
                                        Organisasi</a>
                                    <a href="#"
                                        class="block px-6 py-2 text-sm text-gray-600 hover:text-primary-blue hover:bg-gray-50">Tugas
                                        & Fungsi</a>
                                </div>
                            </li>
                            <li class="relative group">
                                ...
                                <div
                                    ...
                                    <a href="{{ route('news.index') }}"
                                        class="block px-6 py-2 text-sm text-gray-600 hover:text-primary-blue hover:bg-gray-50">Berita</a>
                                    <a href="#"
                                        class="block px-6 py-2 text-sm text-gray-600 hover:text-primary-blue hover:bg-gray-50">Pengumuman</a>
                                    <a href="#"
                                        class="block px-6 py-2 text-sm text-gray-600 hover:text-primary-blue hover:bg-gray-50">Agenda</a>
                                </div>
                            </li>
                            <li class="relative">
                                <a href="#"
                            ...
                            <li class="relative group">
                                ...
                                <div
                                    class="absolute hidden group-hover:block bg-white shadow-xl rounded-xl w-56 py-2 z-50 transform -translate-x-1/4 mt-1">
                                    <a href="#"
                                        class="block px-6 py-2 text-sm text-gray-600 hover:text-primary-blue hover:bg-gray-50">Arsip
                                        Digital</a>
                                    <a href="#"
                                        class="block px-6 py-2 text-sm text-gray-600 hover:text-primary-blue hover:bg-gray-50">Layanan
                                        Arsip</a>
                                </div>
                            </li>
                            <li class="relative group">
                                ...
                                <div
                                    class="absolute hidden group-hover:block bg-white shadow-xl rounded-xl w-56 py-2 z-50 transform -translate-x-1/4 mt-1">
                                    <a href="#"
                                        class="block px-6 py-2 text-sm text-gray-600 hover:text-primary-blue hover:bg-gray-50">Program
                                        Unggulan</a>
                                    <a href="#"
                                        class="block px-6 py-2 text-sm text-gray-600 hover:text-primary-blue hover:bg-gray-50">Layanan
                                        Digital</a>
                    ...
                    <div class="flex justify-center py-3 bg-gray-50 rounded-b-[50px]">
                        <a href="#"
                            class="inline-flex items-center px-6 py-2 mx-2 font-semibold text-sm text-gray-700 hover:text-primary-blue transition-colors">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                ...
                <div class="group h-full">
                    <a href="#" class="block h-full">
                        <div
                            class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 relative overflow-hidden h-full flex flex-col justify-between">
                            <!-- Background Pattern -->
                            <div
                            ...
                            <div class="relative z-10">
                                ...
                                <div class="mb-6 transform group-hover:scale-110 transition-transform duration-500">
                                    <div
                                        class="w-24 h-24 mx-auto bg-gradient-to-br from-primary-blue to-blue-600 rounded-2xl shadow-lg flex items-center justify-center p-4">
                                        <img src="{{ asset('img/logo-provmaluku.png') }}" alt="Logo"
                                ...
                                <!-- Hover Effect Button -->
                                <div
                                    class="mt-6 opacity-0 group-hover:opacity-100 transition-all duration-500 transform group-hover:translate-y-0 translate-y-4">
                                    <button
                                        class="w-full bg-primary-blue text-white py-3 px-6 rounded-xl flex items-center justify-center space-x-2 hover:bg-blue-700 transition-colors">
                ...
                <div class="group h-full">
                    <a href="#" class="block h-full">
                        <div
                            class="bg-primary-yellow rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 relative overflow-hidden h-full flex flex-col justify-between">
                            <!-- Background Pattern -->
                            <div
                                class="absolute inset-0 bg-gradient-to-br from-yellow-200 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                            </div>
                            ...
                            <div class="relative z-10">
                                ...
                                <div class="mb-6 transform group-hover:scale-110 transition-transform duration-500">
                                    <div
                                        class="w-24 h-24 mx-auto bg-white rounded-2xl shadow-lg flex items-center justify-center p-4">
                                        <img src="{{ asset('img/logo-provmaluku.png') }}" alt="Logo"
                                            class="w-full h-full object-contain">
                                    </div>
                                </div>
                                ...
                                <div
                                    class="mt-6 opacity-0 group-hover:opacity-100 transition-all duration-500 transform group-hover:translate-y-0 translate-y-4">
                                    <button
                                        class="w-full bg-white text-gray-800 py-3 px-6 rounded-xl flex items-center justify-center space-x-2 hover:bg-gray-50 transition-colors">
                    ...
                    <a href="#" class="block h-full">
                        <div
                            ...
                            <div class="relative z-10">
                                ...
                                <div class="mb-6 transform group-hover:scale-110 transition-transform duration-500">
                                    <div
                                        class="w-24 h-24 mx-auto bg-gradient-to-br from-green-500 to-green-600 rounded-2xl shadow-lg flex items-center justify-center p-4">
                                        <img src="{{ asset('img/logo-provmaluku.png') }}" alt="iMaluku"
                                            class="w-full h-full object-contain">
                                    </div>
                                </div>
                                ...
                                <div
                                    class="mt-6 opacity-0 group-hover:opacity-100 transition-all duration-500 transform group-hover:translate-y-0 translate-y-4">
                                    <button
                                        class="w-full bg-green-500 text-white py-3 px-6 rounded-xl flex items-center justify-center space-x-2 hover:bg-green-600 transition-colors">
                    ...
                    <div
                        ...
                        <div class="relative h-48">
                            <img src="{{ Storage::url($item['image']) }}" alt="{{ $item['title'] }}"
                                class="w-full h-full object-cover" onerror="this.src='') }}'">
                            <div
                                class="absolute top-4 left-4 bg-primary-blue text-white px-3 py-1 rounded-full text-sm">
    ...
    <div class="bg-gradient-to-b from-gray-50 to-gray-100 py-20">
        <div class="max-w-5xl mx-auto px-4">
            <div class="text-center mb-16">
                ...
                <p class="text-gray-600 text-lg">Kami sangat menghargai setiap masukan dari Anda untuk meningkatkan
                    layanan kami</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-12 mb-16">
                ...
                <div class="md:col-span-4">
                    ...
                    <p class="text-white/70 leading-relaxed mb-8">
                        Dinas Perpustakaan dan Kearsipan Provinsi Maluku berkomitmen untuk melestarikan warisan budaya
                        dan pengetahuan Maluku melalui layanan perpustakaan dan kearsipan yang modern.
                    </p>
                    <div class="flex space-x-4">
                        <a href="#"
                            class="bg-white/10 p-3 rounded-full hover:bg-white/20 transition-colors z-30 relative">
                ...
                <div class="md:col-span-2 relative z-30">
                    ...
                    <ul class="space-y-4">
                        <li>
                            <a href="#"
                                class="text-white/70 hover:text-white transition-colors flex items-center group">
                                <i
                ...
                <div class="md:col-span-3 relative z-30">
                    ...
                    <ul class="space-y-4">
                        <li>
                            <a href="https://maps.google.com/?q=Dinas+Perpustakaan+dan+Kearsipan+Provinsi+Maluku"
                                target="_blank" class="flex items-start group hover:text-white">
                                <div
                                    class="bg-white/10 p-2 rounded-full mr-4 mt-1 group-hover:bg-white/20 transition-colors">
                                    <i class="fas fa-map-marker-alt"></i>
                                </div>
                                <span class="text-white/70 group-hover:text-white transition-colors">Jl. Sultan
                                    Babullah No.1, Kota Ambon, Maluku 97128</span>
                            </a>
                        </li>
                        <li>
                            <a href="tel:+62911123456" class="flex items-center group hover:text-white">
                                <div
                                    class="bg-white/10 p-2 rounded-full mr-4 group-hover:bg-white/20 transition-colors">
                                    <i class="fas fa-phone-alt"></i>
                                </div>
                                <span class="text-white/70 group-hover:text-white transition-colors">+62 911
                                    123456</span>
                            </a>
                        </li>
                        <li>
                            <a href="mailto:dispusip@malukuprov.go.id"
                                ...
                                <span
                                    class="text-white/70 group-hover:text-white transition-colors">dispusip@malukuprov.go.id</span>
                            </a>
                        </li>
                    </ul>
                </div>
